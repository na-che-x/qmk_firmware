...
[0] = LAYOUT(
  ...
  KC_LCTRL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     XXXXXXX,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_QUOT,
...
[2] = LAYOUT(
  ...
  _______, KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT,  KC_END,                     KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT,  KC_END, KC_PGUP,
  _______, _______,  WINLFT,  WINRHT, _______, _______, KC_MUTE,   _______, _______, LGUI(LSFT(KC_LEFT)), LGUI(LSFT(KC_RGHT)), _______, _______, KC_PGDN,
                      KC_LGUI, KC_LALT, TT(1), KC_SPC, KC_SPC,            KC_ENT,  MO(2), MO(3), MO(4), GAMING
),
