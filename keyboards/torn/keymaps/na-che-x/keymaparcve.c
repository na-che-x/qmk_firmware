...
// enum torn_layers { 1, 2, 3, 4 };

#define S_BSPC LSFT_T(KC_BSPC)
#define R_DEL LT(MO(1), KC_DEL)
#define G_ENT LGUI_T(KC_ENT)
#define L_SPC LT(MO(2), KC_SPC)
...
layer_state_t layer_state_set_user(layer_state_t state) {
    torn_set_led(0, IS_LAYER_ON_STATE(state, 2));
    torn_set_led(1, IS_LAYER_ON_STATE(state, 3));
    torn_set_led(2, IS_LAYER_ON_STATE(state, 4));
    return state;
}
